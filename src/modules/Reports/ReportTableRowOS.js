...
import OSQuickDetail from "./ReportComponent/OSQuickDetail"

function ReportTableRowOS(props){ 
  ...
  const report=props.report
    return(<React.Fragment>
        <tr>
            ...
            <td>
              <div className="cu-avatar">
                ...
                <div className="cu-name">
                  <p className="name">{report.os}</p>
                  <p className="email">{report.logType}</p>
                </div>
              </div>
            </td>
            <td>
          ...
          <td colSpan="9"><OSQuickDetail report={report}/></td></tr>
            :<React.Fragment></React.Fragment>}
            </React.Fragment>
    )
}
export default ReportTableRowOS