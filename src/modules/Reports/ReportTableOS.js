...
import ReportTableRowOS from "./ReportTableRowOS";

function ReportTableOS(props){
    ...
    return( 
        ...
        <tbody>
          {(reportList&&reportList.filter)?reportList.filter.map((report,i)=>(
            <ReportTableRowOS detail={detail} showDetail={showDetail} 
