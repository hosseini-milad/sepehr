...
function ReportTableRowSpan(props){ 
            ...
            <td>
              <div className="cu-avatar">
                ...
                <div className="cu-name">
                  <p className="name">{report.raw._source.layers.eth["eth.src"]}</p>
                  <p className="email">type: {report.raw._source.layers.eth["eth.type"]}</p>
                </div>
              </div>
            </td>
            <td>
              <div className="cu-phone">
                <p className="phone-num">{report.raw._source.layers.tcp["tcp.dstport"]}</p>
              </div>
            </td>
            <td>
...
export default ReportTableRowSpan